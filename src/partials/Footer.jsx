        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">VetCastle - Pawsitively Tailored for Veterinary Brilliance! 🐾 Stay tuned for a howling good time as we fetch the future of pet care. Coming Soon</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <li className="mb-1">
                  ...
                  <li className="mb-1">
                    <Link to="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Web Solution</Link>
                  </li>
                  <li className="mb-1">
                    <Link to="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Andriod App</Link>
                  </li>
                  <li className="mb-1">
                    <Link to="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Apple iOS App</Link>
                  </li>
                </ul>
              </div>
              ...
              {/*<div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link to="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Documentations</Link>
                  </li>
                  <li className="mb-1">
                    <Link to="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">FAQ</Link>
                  </li>
                  <li className="mb-1">
                    <Link to="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Blogs</Link>
                  </li>
                  <li className="mb-1">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link to="https://mayimdazzle.com" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">About US</Link>
                  </li>
                  <li className="mb-1">
                    <Link to="https://mayimdazzle.com/#contacts" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Contact US</Link>
                  </li>
                  {/*<li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; vetcastle.com. All rights reserved.</div>
